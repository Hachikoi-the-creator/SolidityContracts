// const { ethers } = require("hardhat");//same as `import React from 'react'`
// const { expect } = require("chai");

// // ? Verify the contract gives half total supply to the owner
// describe("BasicToken contract", function () {
//   it("Deployment should assign half total supply of tokens to the owner", async () => {
//     const [owner] = await ethers.getSigners();

//     const BasicToken = await ethers.getContractFactory("BasicToken");

//     const hardhatToken = await BasicToken.deploy(10000);// constructor param
...
//     const hardhatToken = await BasicToken.deploy(10000);
